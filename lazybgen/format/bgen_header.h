#ifndef LAZYBGEN_BGEN_FORMAT_BGEN_HEADER_H
#define LAZYBGEN_BGEN_FORMAT_BGEN_HEADER_H
...
template <typename T>
inline T read_le(const uint8_t* buffer) {
    T value;
...
struct BgenHeader {
    ...
    uint32_t n_variants;  // Number of variants
...
#endif  // LAZYBGEN_BGEN_FORMAT_BGEN_HEADER_H